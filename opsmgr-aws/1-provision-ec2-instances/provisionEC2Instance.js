...
function usage() {
  console.log('Usage: provisionEC2Instance keyName securityGroupID tagName tagOwner rootVolumeGB instanceType imageId etcHostname');
...
try {
  ...
  var tagName = myArgs[2];
  var tagOwner = myArgs[3];
  var rootVolumeGB = myArgs[4];
  var instanceType = myArgs[5];
  var imageId = myArgs[6];
  var etcHostname = myArgs[7];
