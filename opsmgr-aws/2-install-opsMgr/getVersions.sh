...
download_file mongodb-database-tools-rhel80-x86_64-100.7.0.tgz https://fastdl.mongodb.org/tools/db
download_file mongodb-database-tools-rhel80-x86_64-100.6.1.tgz https://fastdl.mongodb.org/tools/db
