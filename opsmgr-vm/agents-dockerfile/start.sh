...
# Added by JJanos
# It may not be Docker best practice to put this here.
# rsyslog needs to be running in order to deploy a BI Connector.
# The package itself had to be installed via the Dockerfile.
