...
cp /opt/mongodb/mms/conf/conf-mms.properties /opt/mongodb/mms/conf/conf-mms.properties.5.17.preserve
# This changes from version to version, but it's not customized here
cp /opt/mongodb/mms/conf/mms.conf /opt/mongodb/mms/conf/mms.conf.5.17.preserve
cp /etc/mongodb-mms/gen.key /etc/mongodb-mms/gen.key.5.17.preserve

echo "Downloading Ops Manager binary..."
omFile=mongodb-mms-6.0.7.100.20221129T1444Z.amd64.deb
